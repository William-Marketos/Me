  ...
  const TRACKS = [
    {
      ...
      artist: 'Nature',
      desc:   'Birds out in the wonderful wild',
    },
    {
      src:    'music/test.mp3',
      title:  'Scorpion Moon',
      artist: 'William Marketos',
      desc:   'Desert blues, Namibia',
    },
    {
      src:    'music/test.mp3',
      title:  'Salt Pan Reverie',
      artist: 'William Marketos',
      desc:   'Ambient, Etosha flats',
    },
    {
      src:    'music/test.mp3',
      title:  'Outback Lullaby',
      artist: 'William Marketos',
      desc:   'Acoustic, Australian Northern Territory',
    },
    {
      src:    'music/test.mp3',
      title:  'Stars Over Sossusvlei',
      artist: 'William Marketos',
      desc:   'Harmonica & ambient, Namib desert',
    },
  ];
